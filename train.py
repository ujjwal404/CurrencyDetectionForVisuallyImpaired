...
parser.add_argument('--model_dir', 
                    default='experiments/smaller_model/4_ConvBlock',
                    help="Experiment directory containing params.json")
parser.add_argument('--data_dir', default='/Users/ujjwal/Documents/data/224x224_currency',
...
if __name__ == '__main__':
    ...
    values= list(train_inputs.values())
